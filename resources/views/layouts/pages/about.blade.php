                    ...
                    <div class="col-lg-6">
                        <div class="pp-about-content">
                            ...
                            <p class="pp-text wow fadeInUp" data-wow-delay=".5s">
                                ...
                                risus, volutpat a vestibulum ut, tempus et quam. Nulla vitae erat blandit, mattis nisl ut,
                            ...
                            <div class="pp-about-item">
                                ...
                                <div class="pp-about-text wow fadeInUp" data-wow-delay=".5s">
                                    <h6>
                                        <img src="assets/img/home-1/icon/cheak.svg" alt="img"> Powerful Automation
                                    </h6>
                                    <p>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                    <div class="pp-how-work-items">
                        ...
                        <p>
                            Aenean id est pellentesque, consequat sem et, viverra lacus. Aliquam tincidunt.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="pp-how-work-items pp-style-2">
                        ...
                        <p>
                            Mauris dignissim vel augue vel congue. Pellentesque sit amet metus tortor hendrerit.
                        </p>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="pp-key-feature-content">
                            ...
                            <p class="pp-text wow fadeInUp" data-wow-delay=".5s">
                                Duis congue eget neque sit amet mollis. Aliquam auctor diam sit amet efficitur condimentum.
                                Aliquam vitae scelerisque leo, eu vulputate felis.
                            </p>
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="pp-key-feature-content">
                            ...
                            <p class="pp-text wow fadeInUp" data-wow-delay=".5s">
                                Donec eu hendrerit lorem. In ultrices erat pulvinar venenatis auctor. Fusce porta massa sit
                                amet leo rutrum, id imperdiet diam pretium. quis lacinia dui.
                            </p>
                            <ul class="pp-feature-list wow fadeInUp" data-wow-delay=".3s">
                                <li>
                                    Intuitive Drag & Drop Editor
